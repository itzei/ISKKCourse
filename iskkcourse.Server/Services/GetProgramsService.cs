...
namespace ISKKCourse.Server.Services
{
    public class GetProgramService(AppDbContext context) : IGetProgramService
    {
        ...
        private ProgramDto MapDto(Programs program) => new ProgramDto(program.Id, program.StudyFieldGroup, program.Institution, program.StudyField, program.City, program.ProgramTitle, program.Credits, program.Description);
    }
}
